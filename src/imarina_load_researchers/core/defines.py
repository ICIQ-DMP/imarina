...
A3_DUMPS_FOLDER_NAME = "a3"
UPLOADS_FOLDER_NAME = "uploads"

SHAREPOINT_REMOTE_INPUT_DIR = SHAREPOINT_REMOTE_BASE_DIR / INPUT_FOLDER_NAME
SHAREPOINT_REMOTE_OUTPUT_DIR = SHAREPOINT_REMOTE_BASE_DIR / OUTPUT_FOLDER_NAME
SHAREPOINT_REMOTE_A3_DIR = SHAREPOINT_REMOTE_BASE_DIR / A3_DUMPS_FOLDER_NAME
SHAREPOINT_REMOTE_UPLOADS_DIR = SHAREPOINT_REMOTE_BASE_DIR / UPLOADS_FOLDER_NAME
...
SHAREPOINT_LOCAL_UPLOADS_DIR = SHAREPOINT_LOCAL_BASE_DIR / SHAREPOINT_REMOTE_UPLOADS_DIR
...
SHAREPOINT_INPUT_FOLDER = SHAREPOINT_REMOTE_BASE_DIR / INPUT_FOLDER_NAME
...
DEFAULT_COUNTRIES_DICT = SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["countries"]
DEFAULT_JOBS_DICT = SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["jobs"]
DEFAULT_IMARINA_INPUT = SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["imarina"]
DEFAULT_A3_INPUT = SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["a3"]
DEFAULT_OUTPUT_PATH = SHAREPOINT_LOCAL_OUTPUT_DIR / OUTPUT_FILENAME
DEFAULT_PERSONAL_WEB_PATH = (
    SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["personal_web"]
)
DEFAULT_UNIT_GROUP_PATH = (
    SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["unit_group"]
)
DEFAULT_ENTITY_TYPE_PATH = (
    SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["unit_type"]
)
DEFAULT_JOB_DESCRIPTION_ENTITY_PATH = (
    SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["job_description_entity"]
)
DEFAULT_SEX_PATH = SHAREPOINT_LOCAL_INPUT_DIR / REQUIRED_INPUT_FILES["sex"]
...
DEFAULT_UPLOAD_FILE_PATH = SHAREPOINT_LOCAL_OUTPUT_DIR / FTP_FILENAME
DEFAULT_TARGET_FOLDER = SHAREPOINT_REMOTE_BASE_DIR / OUTPUT_FOLDER_NAME
